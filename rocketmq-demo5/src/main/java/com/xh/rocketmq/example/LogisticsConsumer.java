...
@Slf4j
@Component
@RocketMQMessageListener(topic = "logistics-topic", consumerGroup = "tag-group", selectorType = SelectorType.TAG, selectorExpression = "logistics-tag")
public class LogisticsConsumer implements RocketMQListener<String> {
    @Override
    public void onMessage(String s) {
        log.info("LogisticsConsumer onMessage: {}", s);
    }
